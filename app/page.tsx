  ...
  return (
    <>
      ...
      <div className="cards">
        ...
        <div className="card"><h2>廃校（2021年以降128校）</h2><p>文科省の学校コード一覧から、岩手県で{FIRST_CLOSED}年以降に廃止された学校を市町村別に。廃校名・廃止年・学校種の一覧つき。現存校数と合わせて「この6年でどれだけ消えたか」がわかる。</p><Link className="more" href="/haikou/">市町村別の廃校を見る →</Link></div>
        <div className="card"><h2>病院・歯科・薬局とHP公表率</h2><p>医療情報ネットの施設個票から、市町村別の病院・診療所・歯科・薬局・助産所の数と、案内用ホームページを届け出ている施設の割合を（{IRYOU_ASOF_LABEL}時点）。人口1万人当たりと県内順位つき。</p><Link className="more" href="/iryou/">市町村別の医療機関・薬局を見る →</Link></div>
        <div className="card"><h2>介護サービス事業所</h2><p>介護サービス情報公表システムの事業所個票から、市町村別の訪問介護・通所介護・グループホームなど{KAIGO_SERVICES.length}種別の事業所数と定員を。高齢者千人当たりと県内順位つき。</p><Link className="more" href="/kaigo/">市町村別の介護事業所を見る →</Link></div>
        <div className="card"><h2>障害福祉サービス事業所</h2><p>障害福祉サービス等情報公表システムの事業所個票から、就労継続支援・放課後等デイサービス・共同生活援助など{SHOFUKU_SERVICES.length}種別の事業所数を市町村別に（{SHOFUKU_ASOF_LABEL}時点）。ホームページ公表率つき。</p><Link className="more" href="/shofuku/">市町村別の障害福祉事業所を見る →</Link></div>
        <div className="card"><h2>法人数（法人番号公表サイト）</h2><p>国税庁の法人番号 全件データから、市町村別の株式会社・有限会社・合同会社の数を（{HOUJIN_ASOF_LABEL}時点）。人口千人当たり、有限会社率、{FIRST_HOUJIN_YEAR}年以降の新設数つき。</p><Link className="more" href="/houjin/">市町村別の法人数を見る →</Link></div>
        <div className="card"><h2>交通事故（警察庁）</h2><p>警察庁が公開する人身事故1件ごとの記録から、市町村別の事故件数・死者数・負傷者数を{FIRST_TRAFFIC}〜{LATEST_TRAFFIC}年で。人口1万人当たりと県内順位つき。</p><Link className="more" href="/jiko/">市町村別の交通事故を見る →</Link></div>
