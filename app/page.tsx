...
import { MUNIS, INDUSTRIES, PREF, dentalAt, popAt, econAt, fmt, fmtSigned, LATEST_DENTAL, LATEST_POP, SITE, censusAt, agingRate, LATEST_CENSUS, buildPrefAt, LATEST_BUILD, FIRST_BUILD, vitalPrefAt, LATEST_VITAL, FIRST_VITAL, naturalChange, housePrefAt, LATEST_HOUSE, FIRST_HOUSE, hhShare, medPrefAt, LATEST_MED, FIRST_MED, LATEST_DOC_YEAR, welPrefAt, LATEST_WEL, FIRST_WEL, schoolPrefAt, LATEST_SCHOOL, FIRST_SCHOOL, econPrefAt, LATEST_ECON, FIRST_ECON, incomePerTaxpayer, envPrefAt, envPrefPerDay, LATEST_ENV, FIRST_ENV } from '@/lib/data';
