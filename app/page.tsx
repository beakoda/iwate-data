  ...
  return (
    <>
      ...
      <div className="cards">
        ...
        <div className="card"><h2>保育所等の定員・待機児童</h2><p>こども家庭庁の取りまとめから、市町村別の保育所等の利用定員・申込者・待機児童を（{HOIKU_ASOF_LABEL}時点）。待機児童に数えない「特定園のみ希望」なども。</p><Link className="more" href="/hoiku/">市町村別の保育所等を見る →</Link></div>
