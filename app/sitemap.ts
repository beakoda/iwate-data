...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [u('/', 1), u('/dental/', 0.9), u('/population/', 0.9), u('/industry/', 0.9), u('/aging/', 0.9), u('/work/', 0.9), u('/building/', 0.9), u('/medical/', 0.9), u('/welfare/', 0.9), u('/school/', 0.9), u('/jobless/', 0.9), u('/education/', 0.9), u('/farm/', 0.9), u('/economy/', 0.9), u('/garbage/', 0.9), u('/vital/', 0.9), u('/household/', 0.9), u('/city/', 0.8),
