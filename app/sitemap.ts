...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [u('/', 1), u('/dental/', 0.9), u('/population/', 0.9), u('/industry/', 0.9), u('/aging/', 0.9), u('/work/', 0.9), u('/building/', 0.9), u('/city/', 0.8),
    ...MUNIS.flatMap(m => [u(`/city/${m.slug}/`, 0.8), u(`/dental/${m.slug}/`, 0.7), u(`/population/${m.slug}/`, 0.7), u(`/aging/${m.slug}/`, 0.7), u(`/work/${m.slug}/`, 0.7), u(`/building/${m.slug}/`, 0.7)]),
