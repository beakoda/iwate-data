...
### 非 e-Stat データの利用条件（2026-09-10 調査）
...
**他の非e-Stat ソース（kaigo / iryou / shofuku / schoolcode / traffic / houjin / hoiku）の規約は未実読。** いずれも国の機関の公開データで政府標準利用規約（CC BY 4.0 互換）が通例だが、**実際に規約を読んで確認していない**。商用の Excel データ集に含めている以上、いずれ1つずつ確認して本節に追記すること。
